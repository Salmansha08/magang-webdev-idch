...
(function (root, factory) {
  ...
  DateRangePicker.prototype = {
    ...
    renderTimePicker: function (side) {
      ...
      let html; let selected; let minDate; let maxDate = this.maxDate
      ...
      if (side == 'left') {
        ...
        const timeSelector = this.container.find('.calendar.right .calendar-time div')
